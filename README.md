...
| 登录 | 仪表盘 | 饮食记录 |
|------|--------|----------|
| ![登录](screenshots/login.png) | ![仪表盘](screenshots/dashboard.png) | ![饮食记录](screenshots/diet.png) |

| AI 解析 | 统计分析 | 食物数据库 |
|---------|----------|------------|
| ![AI](screenshots/ai.png) | ![统计](screenshots/stats.png) | ![食物](screenshots/food.png) |
