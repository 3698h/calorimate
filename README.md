...
本项目包含 **两个前端版本**：Web 端和微信小程序端，共享同一个后端服务。

| 版本 | 说明 | 推送时间 |
|------|------|----------|
| Web 版（calorimate-frontend） | 基于 Vue 3 + Element Plus 的浏览器端 | 2026-05-01 |
| 微信小程序版（miniapp） | 基于 Taro 4 + Vue 3 的微信小程序 | 2026-05-02 |
...
- **拍照识别**（小程序版）：调用手机摄像头拍照，AI 识别食物并记录
- **微信登录**（小程序版）：支持微信一键登录
- **会员订阅**（小程序版）：VIP 付费订阅功能
